export const teamMembers = {
  "sopian-sitepu": {
    name: "Dr. Sopian Sitepu, S.H., M.H., M.Kn.",
    role: "Managing Partner",
    image: "images/sopian.webp",
    bio: [
      "Sopian Sitepu merupakan salah satu pengacara yang berpengalaman dan memiliki pengetahuan hukum yang luas di Indonesia, lebih dari 20 tahun menjadi akademisi dan praktisi hukum dalam menangani berbagai perkara dan permasalahan hukum di Indonesia. Spesialisasi yang ditangani Sopian Sitepu seperti dalam perkara-perkara korporasi, perselisihan antara perusahaan inti dan plasma, tindak pidana korupsi baik yang ditangani oleh kepolisian, kejaksaan maupun Komisi Pemberantasan Korupsi, penyelesaian sengketa di Badan Arbitrase, hukum kesehatan, teknik negosiasi dan lobby, serta sengketa pada Peradilan Tata Usaha Negara. Sopian Sitepu juga telah berhasil membawa Kantor Hukum Sopian Sitepu & Partners menjadi salah satu kantor hukum terbaik di Indonesia dan meraih berbagai penghargaan tingkat nasional. Sopian Sitepu selalu mengedepankan profesionalitas dan prinsip equality before the law serta selalu mengupdate peraturan yang berlaku guna memberikan pelayanan dan penyelesaian permasalahan terbaik bagi Klien."
    ],
    lead: "Sopian Sitepu merupakan salah satu pengacara yang berpengalaman dan memiliki pengetahuan hukum yang luas di Indonesia, lebih dari 20 tahun menjadi akademisi dan praktisi hukum dalam menangani berbagai perkara dan permasalahan hukum di Indonesia.",
    specialties: [
      "Perkara-perkara korporasi",
      "Perselisihan antara perusahaan inti dan plasma",
      "Tindak pidana korupsi",
      "Penyelesaian sengketa di Badan Arbitrase",
      "Hukum kesehatan",
      "Teknik negosiasi dan lobby",
      "Sengketa pada Peradilan Tata Usaha Negara"
    ],
    education: [
      "Universitas Sumatera Utara, Sarjana Hukum (S.H.), 1986",
      "Universitas Indonesia, Magister Hukum (M.H.), 1996",
      "Universitas Diponegoro, Magister Kenotariatan (M.Kn.), 2010",
      "Universitas Airlangga, Doktor (Dr), 2020"
    ],
    associations: ["Perhimpunan Advokat Indonesia (PERADI)"],
    training: ["Pendidikan Penyelesaian Sengketa Alternatif (1995 & 2002)"],
    awards: [
      "Membimbing PSBH UNILA Juara III Piala Djoko Soetono 1999 Kompetisi Peradilan Semu Se-Indonesia (UI)",
      "Membimbing PSBH UNILA Juara I Piala Djoko Soetono 2003 Kompetisi Peradilan Semu Se-Indonesia (UI)",
    ...
    organizations: [
      "Ketua Bidang Bantuan Hukum pada Bidang Konsultasi dan Bantuan Hukum UNILA (2000-2006)",
      "Pembina Unit Pelayanan Teknis Pusat Studi Bantuan Hukum (1997-Sekarang)",
      "Ketua Bidang Hukum dan Advokasi KONI Provinsi Lampung (2023-Sekarang)",
      "Ketua Federasi Hoki Indonesia Provinsi Lampung (2018-Sekarang)"
    ],
    otherExperience: [
      "Dosen Fakultas Hukum Universitas Lampung (1988-2007)",
      "Dosen Fakultas Hukum Universitas Bandar Lampung (1990-1994)",
      "Dosen Fakultas Hukum Universitas Tulang Bawang (2023-2024)",
      "Direktur LBH RI (1991-1993)",
      "Direktur LBH-Nasional (1996-Sekarang)"
    ],
    facts: [
  ...
  "kabul-budiono": {
    ...
    lead: "Kabul Budiono merupakan Advokat Senior yang di Kantor Hukum Sopian Sitepu & Partners.",
    specialties: [
      "Hukum perdata",
      "Pidana umum dan khusus",
      "Hukum pertanahan",
      "Hukum tata usaha negara",
      "Perdata Islam, waris, dan ekonomi syariah",
      "BANI",
      "Hukum kesehatan"
    ],
    education: ["Universitas Lampung, Magister Hukum (M.H.)"],
    facts: [["Posisi", "Advokat Senior"]]
  },

  "simon-petrus-ginting": {
    name: "Simon Petrus Ginting, S.H.",
    role: "Advokat & Kurator",
    image: "images/simon-petrus.png",
    bio: [
      "Simon Petrus Ginting merupakan advokat dan kurator yang tergabung dalam PERADI dan AKPI. Selain itu, Simon Petrus Ginting juga telah meraih dan masuk kedalam daftar ekslusif para Partner dari kantor hukum terkemuka dan lulusan kampus-kampus terbaik di Indonesia \"Hall Of Fame\" dari Hukum Online. Simon Petrus Ginting memfokuskan diri sebagai seorang advokat dalam area hukum kepailitan, korporasi, tindak pidana korupsi, Penundaan Kewajiban Pembayaran Utang (PKPU), sengketa pertanahan, hukum pajak, pidana dan juga perdata. Dengan pengalaman sebagai seorang advokat dan kurator yang luas, Simon Petrus Ginting sangat memahami bagaimana praktik hukum di Indonesia, sehingga dapat memberikan solusi-solusi yang strategis atas permasalahan dan perkara yang dialami Klien."
    ],
    lead: "Simon Petrus Ginting merupakan advokat dan kurator yang tergabung dalam PERADI dan AKPI.",
    specialties: [
      "Hukum kepailitan",
      "Korporasi",
      "Tindak pidana korupsi",
    ...
    education: ["Universitas Lampung, Sarjana Hukum (S.H.), 2010"],
    associations: [
    ...
    facts: [
      ["Posisi", "Advokat & Kurator"],
      ["Asosiasi", "PERADI & AKPI"]
    ]
  },
  ...
  "japriyanto-manalu": {
    ...
    lead: "Japriyanto Manalu merupakan Advokat yang memiliki segudang pengalaman diberbagai bidang hukum.",
    specialties: ["Hukum pidana umum", "Lingkungan hidup dan kehutanan", "Hukum pertanahan"],
    education: [
      "Universitas Lampung, Sarjana Hukum (S.H.), 2010",
      "Universitas Lampung, Magister Hukum (M.H.), 2024"
    ],
    facts: [["Posisi", "Advokat"]]
  },
  ...
  "prandika-bangun": {
    ...
    associations: ["Perhimpunan Advokat Indonesia (PERADI)"],
    training: ["Pendidikan dan Pelatihan Khusus Brevet Pajak Terapan A & B + Identifikasi Sengketa 2024"],
    facts: [
      ["Posisi", "Advokat"],
      ["Asosiasi", "PERADI"]
    ]
  ...
  "chaerul-tri-rizki-sembiring": {
    name: "Chaerul Tri Rizki Sembiring, S.H.",
    role: "Advokat",
    image: "images/chaerul.png",
    bio: [
      "Chairul Sembiring merupakan salah satu Advokat yang memiliki intelektual dan pengetahuan hukum yang luas. Chairul Sembiring memiliki spesialisasi terkait dengan legal drafting, hukum perdata, hukum pidana, hukum ketenagakerjaan, dan hubungan industrial. Chairul Sembiring sering terlibat dalam berbagai pembuatan/drafting kontrak baik badan hukum maupun individu. Ketelitiannya dalam menafsir dan merancang klausul perjanjian membuat setiap perjanjian yang dirancang memiliki kepastian hukum bagi Klien. Selain itu, Chairul Sembiring juga aktif memberikan konsultasi terkait dengan hukum ketenagakerjaan dan hukum hubungan industrial kepada Klien"
    ],
    lead: "Chairul Sembiring merupakan salah satu Advokat yang memiliki intelektual dan pengetahuan hukum yang luas.",
    specialties: ["Legal drafting", "Hukum perdata", "Hukum pidana", "Hukum ketenagakerjaan", "Hubungan industrial"],
    education: ["Universitas Diponegoro, Sarjana Hukum (S.H.), 2016"],
    associations: ["Perhimpunan Advokat Indonesia (PERADI)"],
    training: ["Pendidikan dan Pelatihan Kontrak Fakultas Hukum Universitas Diponegoro 2014"],
    otherExperience: ["Internship pada Kementerian Luar Negeri Republik Indonesia, 2015"],
    facts: [
      ["Posisi", "Advokat"],
      ["Asosiasi", "PERADI"]
    ]
  ...
  "firdaus-pardede": {
    ...
    lead: "Firdaus Pardede merupakan Advokat yang memiliki keahlian dalam bidang hukum perdata, hukum pidana, dan legal drafting.",
    specialties: ["Hukum perdata", "Hukum pidana", "Legal drafting", "Wanprestasi", "Perbuatan melawan hukum"],
    education: ["Universitas Lampung, Sarjana Hukum (S.H.), 2018"],
    associations: ["Perhimpunan Advokat Indonesia (PERADI)"],
    training: ["Countinuing Legal Education FH UI Perhimpunan Advokat Indonesia, 2015"],
    facts: [
      ["Posisi", "Advokat"],
      ["Asosiasi", "PERADI"]
    ]
  ...
  "rilda-murniati": {
    name: "Rilda Murniati, S.H., M.Hum.",
    role: "Tenaga Ahli Bidang Hukum Perusahaan/Ekonomi dan Kontrak Bisnis",
    image: "images/rilda-murniati.webp",
    bio: ["Tenaga Ahli Bidang Hukum Perusahaan/Ekonomi dan Kontrak Bisnis"],
    lead: "Tenaga Ahli Bidang Hukum Perusahaan/Ekonomi dan Kontrak Bisnis",
    education: [
      "Universitas Lampung, Sarjana Hukum (S.H.), 1993",
      "Universitas Gadjah Mada, Magister Humaniora (M.Hum.), 1998"
    ],
    facts: [["Posisi", "Tenaga Ahli Bidang Hukum Perusahaan/Ekonomi dan Kontrak Bisnis"]]
  },

  "m-fakih": {
    name: "Dr. M.Fakih, S.H., M.S.",
    role: "Tenaga Ahli Bidang Hukum Kesehatan",
    image: "images/fakih.png",
    bio: ["Tenaga Ahli Bidang Hukum Kesehatan"],
    lead: "Tenaga Ahli Bidang Hukum Kesehatan",
    education: [
      "Universitas Lampung, Sarjana Hukum (S.H), 1988",
      "Universitas Gadjah Mada, Magister Sains (M.S.), 1992",
      "Universitas Gadjah Mada, Doktor (Dr.), 2012"
    ],
    facts: [["Posisi", "Tenaga Ahli Bidang Hukum Kesehatan"]]
  },

  "heni-siswanto": {
    name: "Dr. Heni Siswanto, S.H., M.H",
    role: "Tenaga Ahli Bidang Hukum Pidana",
    image: "images/heni-siswanto.webp",
    bio: ["Tenaga Ahli Bidang Hukum Pidana"],
    lead: "Tenaga Ahli Bidang Hukum Pidana",
    education: [
      "Universitas Diponegoro, Sarjana Hukum (S.H.), 1988",
      "Universitas Lampung, Magister Hukum (M.H.), 2003",
      "Universitas Diponegoro, Doktor (Dr.), 2014"
    ],
    facts: [["Posisi", "Tenaga Ahli Bidang Hukum Pidana"]]
  },

  "ade-arif-firmansyah": {
    name: "Dr. Ade Arif Firmansyah, S.H., M.H.",
    role: "Tenaga Ahli Bidang Hukum Tata Negara",
    image: "images/ade-arif.png",
    bio: ["Tenaga Ahli Bidang Hukum Tata Negara"],
    lead: "Tenaga Ahli Bidang Hukum Tata Negara",
    education: [
      "Universitas Lampung, Sarjana Hukum (S.H.), 2008",
      "Universitas Lampung, Magister Hukum (M.H.), 2012",
      "Universitas Lampung, Doktor (Dr.), 2024"
    ],
