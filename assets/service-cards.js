...
const serviceCards = [
    ...
    title: { id: "Lelang, Eksekusi & Pengamanan Aset", en: "Auctions, Enforcement & Asset Security" }, category: { id: "Pengamanan & Pengosongan Aset", en: "Mortgage & Direct Enforcement" }, alt: { id: "Placeholder lelang dan eksekusi", en: "Auction and enforcement placeholder" },
  ...
  },
   {
    ...
    title: { id: "Pertanahan, Properti & Real Estate", en: "Land, Property & Real Estate" }, category: { id: "Sengketa Pertanahan & Konflik Agraria", en: "Ownership & Agrarian Disputes" }, alt: { id: "Placeholder pertanahan dan properti", en: "Land and property placeholder" },
  ...
  },
  {
    ...
    title: { id: "Penanganan Blokir, Roya, Balik Nama & Perpanjangan SHGB", en: "Handling Blockage, Release, Title Transfer & SHGB Extension" }, category: { id: "Hak Atas Tanah & Administrasi Tanah", en: "Mortgage & Land Administration" }, alt: { id: "Placeholder blokir, roya, balik nama dan perpanjangan SHGB", en: "Blocking, release, title transfer and SHGB extension placeholder" },
  ...
  },
  {
    ...
    title: { id: "Litigasi & Penyelesaian Sengketa", en: "Litigation & Non Litigation" }, category: { id: "Litigasi", en: "Litigation & Non Litigation" }, alt: { id: "Placeholder litigasi dan penyelesaian sengketa", en: "Litigation and dispute resolution placeholder" },
    description: { id: "Pendampingan strategis dalam penyelesaian sengketa melalui litigasi. Dengan pendekatan yang terukur dan berorientasi pada kepentingan klien, kami menangani berbagai sengketa perdata, pidana, komersial, pertanahan, perbankan, ketenagakerjaan, serta sengketa bisnis lainnya, tata usaha negara mulai dari tahap awal hingga, pendampingan hukum, upaya hukum dan pelaksanaan putusan.", en: "Assistance and representation in civil, commercial and corporate disputes, breach of contract, unlawful acts, ownership disputes and other legal matters. Our services cover case strategy, negotiation and mediation, court proceedings, legal remedies, and assistance with the enforcement of judgments." }
  },
  {
  ...
  },
  {
    ...
    title: { id: "Hukum Perdata & Hukum Bisnis", en: "Criminal & Corporate Crime Law" }, category: { id: "Hukum Perdata", en: "White Collar Crime & Compliance" }, alt: { id: "Placeholder hukum pidana dan pidana korporasi", en: "Criminal and corporate crime law placeholder" },
    description: { id: "Memberikan layanan hukum dalam berbagai aspek hukum perdata dan bisnis, meliputi penyusunan dan penelaahan kontrak, transaksi komersial, hubungan korporasi, investasi, restrukturasi bisnis, wanprestasi, perbuatan melawan hukum, serta berbagai persoalan hukum dalam kegiatan usaha. Kami menghadirkan solusi hukum yang strategis dan terukur untuk melindungi kepentingan klien, memitigasi risiko, dan mendukung keberlanjutan bisnis.", en: "Legal assistance for individuals, company officers and corporations facing criminal matters as complainants, reported parties, witnesses or interested parties. Assistance is provided from the initial case assessment through inquiry, investigation, prosecution, trial and subsequent legal remedies." }
  },
  {
  ...
  },
  {
    ...
    title: { id: "Hukum Administrasi Negara & PTUN", en: "State Administrative Law & Administrative Court" }, category: { id: "Tata Usaha Negara", en: "State Administrative Disputes" }, alt: { id: "Placeholder hukum administrasi negara", en: "State administrative law placeholder" },
  ...
  },
  {
    ...
    title: { id: "Negosiasi, Mediasi, Arbitrase & Penyelesaian di Luar Pengadilan", en: "Negotiation, Mediation, Arbitration & Alternative Dispute Resolution" }, category: { id: "Alternatif Penyelesaian Sengketa", en: "Alternative Dispute Resolution" }, alt: { id: "Placeholder negosiasi dan mediasi", en: "Negotiation and mediation placeholder" },
  ...
  },
  {
    ...
    title: { id: "Waris, Hibah, Cerai, dan Harta Gono-Gini", en: "Islamic Law & Inheritance Disputes" }, category: { id: "Hukum Islam & Sengketa Waris", en: "Inheritance, Gifts & Heirs" }, alt: { id: "Placeholder hukum islam dan sengketa waris", en: "Islamic law and inheritance disputes placeholder" },
  ...
  },
  {
    ...
    title: { id: "Konsultan Hukum Tetap", en: "Retainer & Legal Counsel" }, category: { id: "Legal Retainer", en: "Ongoing Legal Assistance" }, alt: { id: "Placeholder retainer dan penasihat hukum", en: "Retainer and legal counsel placeholder" },
    description: { id: "Layanan konsutan hukum tetap dan nasihat hukum berkelanjutan bagi perusahaan, pelaku usaha, organisasi maupun individu dalam menghadapi kebutuhan hukum sehari-hari, pengambilan keputusan, penyusunan kebijakan dan transaksi serta pencegahan dan mitigasi risiko hukum.", en: "Ongoing legal advisory services for companies, business operators, organisations and individuals addressing day-to-day legal needs, decision-making, policy and transaction preparation, and the prevention and mitigation of legal risk." }
  },
  {
    slug: "tindak-pidana-kekerasan-seksual-dan-tindak-pidana-khusus", image: "images/service-special-crime.png",
    title: { id: "Tindak Pidana Umum & Tindak Pidana Khusus ", en: "General Crimes and Other Special Crimes" }, category: { id: "Hukum Pidana", en: "Criminal Law" }, alt: { id: "Placeholder kekerasan seksual dan tindak pidana khusus", en: "Sexual violence and special crimes placeholder" },
    description: { id: "Pendampingan dan pembelaan hukum dalam berbagai perkara tindak pidana umum maupun tindak pidana khusus. Kami mendampingi klien pada setiap tahapan proses hukum, mulai dari penyelidikan dan penyidikan, penuntutan, persidangan, hingga upaya hukum, dengan strategi pembelaan yang cermat, terukur, dan berorientasi pada perlindungan hak serta kepentingan hukum klien.", en: "Legal assistance in sexual violence and special crime matters, whether as victims, witnesses or defendants. Our services include initial consultation, legal strategy development, evidence strengthening, negotiation, and support throughout investigation, prosecution, trial and relevant legal remedies." }
  }
];
