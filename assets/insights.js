...
async function decoratePost(post) {
  ...
  return { ...post, coverUrl, avatarUrl };
}
...
function filteredPosts() {
  ...
  return posts.filter(post => (
    ...
    && (!needle || [post.title, post.excerpt, post.category, post.author_name]
